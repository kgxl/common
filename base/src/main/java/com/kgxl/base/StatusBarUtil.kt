...
object StatusBarUtil {
    ...
    @JvmOverloads
    fun setColor(
        activity: Activity, @ColorInt color: Int, @androidx.annotation.IntRange(from = 0, to = 255) statusBarAlpha: Int = DEFAULT_STATUS_BAR_ALPHA
    ) {
    ...
    @JvmOverloads
    fun setTranslucent(
        activity: Activity, @androidx.annotation.IntRange(from = 0, to = 255) statusBarAlpha: Int = DEFAULT_STATUS_BAR_ALPHA
    ) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return
        }
    ...
    fun setTranslucentForImageView(
        activity: Activity, @androidx.annotation.IntRange(from = 0, to = 255) statusBarAlpha: Int,
        needOffsetView: View?
    ) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return
     ...
     */
    private fun addTranslucentView(activity: Activity, @androidx.annotation.IntRange(from = 0, to = 255) statusBarAlpha: Int) {
        val contentView = activity.findViewById<View>(android.R.id.content) as ViewGroup
